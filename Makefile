...
SRCS       = env_utils.c env.c error_handle.c minihell.c builtins.c parsing.c ft_cd.c leak.c export.c builtins_utils.c export_helper.c export_setting_key_value.c export_utils.c unset.c copy_env.c handle_redirection.c heredoc.c heredoc_helper.c handle_great.c handle_great_utils.c handle_great_main.c
OBJS       = $(SRCS:.c=.o)
